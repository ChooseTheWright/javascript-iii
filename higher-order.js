...
let evenNumbers  = mixedNumbers.filter((numVal) => numVal % 2 === 0);
...
let postTaxPrices  = prices.map((priceVal) => priceVal * 1.07);
...
let totalPopulation = populations.reduce((totalPop, popVal) => totalPop + popVal);
